                    ...
                    <div className="bg-[#141414] basis-[24.5%] py-8 pl-4 rounded-lg">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-[#00DA9D] text-[1.375rem]">
                            Aptos Undead
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="p-4 bg-lightblack rounded-[18px] basis-[29%]">
                      ...
                      <div className="max-h-[230px] 2xl:max-h-[260px] overflow-y-scroll hide-table-wrap">
                        <table className="w-full mt-3">
                            ...
                            <tbody>
                                <tr>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 14, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">77.76 Apt</td>
                                    <td className="text-right text-[0.875rem] text-lightgreen font-light py-[6px] px-1">+18.72%</td>
                                </tr>
                                <tr className="bg-[#1F1F1F29]">
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 13, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">65.5 Apt</td>
                                    <td className="text-right text-[0.875rem] text-lightgreen font-light py-[6px] px-1">+18.72%</td>
                                </tr>
                                <tr>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 12, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">64.48 Apt</td>
                                    <td className="text-right text-[0.875rem] text-lightgreen font-light py-[6px] px-1">+1.58%</td>
                                </tr>
                                <tr className="bg-[#1F1F1F29]">
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 11, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">67.00 Apt</td>
                                    <td className="text-right text-[0.875rem] text-lightred font-light">-3.76%</td>
                                </tr>
                                <tr>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 10, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">77.76 Apt</td>
                                    <td className="text-right text-[0.875rem] text-lightgreen font-light">+12.79%</td>
                                </tr>
                                <tr className="bg-[#1F1F1F29]">
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 11, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">67.00 Apt</td>
                                ...
                                <tr>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 13, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">65.5 Apt</td>
                                    <td className="text-right text-[0.875rem] text-lightred font-light">+18.72%</td>
                                </tr>
                                <tr className="bg-[#1F1F1F29]">
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">Nov 13, 05:29</td>
                                    <td className="text-left text-[#FFFFFFB2] text-[0.875rem] font-light py-[6px] px-1">65.5 Apt</td>
